...
export const getGIRLS = students.filter((student)=> student.lastIndexOf('а') === student.length-1);
export const getBOYS = students.filter((student)=> student.lastIndexOf('а') !== student.length-1);
const teams = getTeam();
